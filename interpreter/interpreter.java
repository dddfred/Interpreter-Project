/*
*
*CISC 3160 Interpreter Project
*Professor: Neng-Fa-Zhou
*Student: Fredy Diaz Peralta
*
* TO RUN, cd into the Interpreter folder in the terminal and java interpreter.java
*
*
* Pourpose: to anylize, report syntax error, unitialized variables and 
* computations. 
*/
 ...
 */
	public static String evaluateExpression(String expression){
		...
		try {
			...
			System.out.println("Expression Syntax error");
		}
